...
@Component({
  ...
  templateUrl: './general-news.page.html',
  styleUrls: ['./general-news.page.scss'],
})
export class GeneralNewsPage implements OnInit {
  ...
  getNews() {
    this.newsService.getNewsData('top-headlines', this.page, 'general').subscribe(data => {
      if (data) {

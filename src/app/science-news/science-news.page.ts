...
@Component({
  ...
  templateUrl: './science-news.page.html',
  styleUrls: ['./science-news.page.scss'],
})
export class ScienceNewsPage implements OnInit {
  ...
  getNews() {
    this.newsService.getNewsData('top-headlines', this.page, 'science').subscribe(data => {
      if (data) {
